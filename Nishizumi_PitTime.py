...
class PitStopOverlay:
    ...
    def _apply_minimal_mode(self) -> None:
        ...
        self.inputs_frame.pack(fill="x", before=self.connection_label)
        self.connection_label.pack(anchor="w", pady=(8, 2), before=self.car_label)
        self.car_label.pack(anchor="w", pady=(0, 4), before=self.top_separator)
        self.top_separator.pack(fill="x", pady=4, before=self.metrics_frame)
        self.metrics_frame.pack(fill="x", pady=(6, 8), before=self.status_frame)
        ...
        self.status_details_label.pack(anchor="w", pady=(10, 4), before=self.legend_label)
        self.legend_label.pack(anchor="w")
        self.root.geometry("500x440")
