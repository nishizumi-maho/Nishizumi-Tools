...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "rules": {
        "pass_request": {
            ...
            "pattern": {"flashes": 3, "min_interval_s": 0.3, "max_interval_s": 0.6, "hold_s": 0.06},
        },
        "safety_approach": {
            "enabled": True,
            "priority": 1,
        ...
        "slow_car_ahead": {
            ...
            "pattern": {"flashes": 2, "min_interval_s": 0.15, "max_interval_s": 0.3, "hold_s": 0.06},
        },
        "pit_exit_merge": {
            "enabled": True,
            "priority": 1,
        ...
        "self_off_track_hazard": {
            ...
            "cooldown_s": 3.0,
            "min_speed_kmh": 30.0,
            "pattern": {"flashes": 2, "min_interval_s": 0.12, "max_interval_s": 0.25, "hold_s": 0.06},
        },
    },
}
